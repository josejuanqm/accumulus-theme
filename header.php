...
?>
  ...
  <script id="cookieyes" type="text/javascript"
    src="https://cdn-cookieyes.com/client_data/6a8bd37ef5551587060acab2/script.js"></script>
  <!-- End cookieyes banner -->
  <div id="page" class="site relative [&>.opened]:fixed [&>.opened]:h-screen [&>.opened>section.mobile-menu]:block">
    <a class="skip-link screen-reader-text"
      href="#primary"><?php esc_html_e( 'Skip to content', 'accumulus-website' ); ?></a>


    <header id="navigation" class="lg:bg-auto fixed w-full z-[999999] text-neutral-sgray group">
      <div
        class="bg-white text-neutral-sgray stroke-cta-dark hidden lg:block border-b-[1px] border-b-neutral-200 content transition-color duration-150">
      ...
      ?>
        <div class="flag hidden lg:block py-s2 w-full relative bg-primary-violet text-neutral-nwhite">
          <p
            class="text-ctaMobile md:text-ctaTablet lg:text-cta text-center flex items-center justify-center flex-col lg:flex-row gap-s5">
            <?php echo $announcement['text_bar'] ?>

            <?php if($announcement['activate_cta']): ?>
            <a target="<?php echo $announcement['cta_bar']['target'] ? $announcement['cta_bar']['target'] : '_self'; ?>"
              href="<?php echo  $announcement['cta_bar']['url']; ?>" class="btn-tertiary-white lg:!min-w-[130px]">
              <?php echo  $announcement['cta_bar']['title']; ?>
            </a>
            <?php endif; ?>
          </p>
        ...
        <div class="container mx-auto px-s2 lg:px-s4 py-s2">
          <div class="flex flex-row items-center justify-end">
            <ul class="flex flex-row items-center justify-end gap-s2 text-sm heading-5">
              ...
              <li><a class="hover:underline" href="<?php echo $menu_item->url; ?>"
                  target="<?php echo $menu_item->title == "LinkedIn" ? "_blank" : ""; ?>"><?php echo $menu_item->title; ?></a>
              </li>
              <?php endforeach; ?>
            </ul>
          </div>
      ...
      <div
        class="bg-white text-neutral-sgray stroke-cta-dark content transition-color duration-150 border-b-neutral-200">
      ...
      ?>
        <div class="lg:hidden flag pt-s5 pb-s2 px-s4 w-full relative bg-primary-violet text-neutral-nwhite z-[9999]">
          <p
            class="text-ctaMobile md:text-ctaTablet lg:text-cta text-center flex items-center justify-center flex-col lg:flex-row gap-s2">
            <?php echo $announcement['text_bar'] ?>
          ...
          <div class="flex flex-row items-center px-s2 md:px-s4 lg:px-0">
            <div class="flex flex-row items-center me-auto">
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>"
                ...
                <svg width="241" height="61" viewBox="0 0 241 61" class="logo fill-cta-dark stroke-none"
                  xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_4005_31882)">
                    <path
                      d="M61.5264 12.7661L53.8125 35.0301H58.2829L59.7781 30.5726H68.6115L70.1067 35.0301H74.5771L66.8632 12.7661H61.534H61.5264ZM61.0816 26.6242L64.1718 17.478L67.2619 26.6242H61.074H61.0816Z" />
            ...
            <div class="flex-row items-center hidden lg:flex">
              <ul class="flex flex-row items-center gap-s4">
                ...
                <li class="menu-item menu-item-dropdown flex flex-row items-center gap-s1"
                  data-identifier="<?php echo $fields["identifier"]; ?>">
                  <a class="py-s2 body-3" href="<?php echo $menu_item->url; ?>"><?php echo $menu_item->title; ?></a>
                  <?php if ($fields["menu_items"]) : ?>
                  <svg class="dropdown-arrow" width="13" height="7" viewBox="0 0 13 7" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.4502 0.825684L6.76582 6.14131L12.0814 0.825684" stroke-width="1.18"
            ...
            <div class="flex flex-row items-center ms-auto">
              <button onclick="setMobileMenuOpened()" class="block lg:hidden">
                <svg class="fill-white stroke-white stroke-0 hamburger" width="35" height="20" viewBox="0 0 35 20"
                  fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M11.4749 3.93832H15.3016H19.1283H22.9551H26.779H30.6057V0H26.779H22.9551H19.1283H15.3016H11.4749H7.65095H3.82422V3.93832H7.65095H11.4749Z" />
                  <path
                    d="M30.6082 7.87109H26.7815H22.9576H19.1308H15.3041H11.4774H7.65347H3.82673H0V11.8094H3.82673H7.65347H11.4774H15.3041H19.1308H22.9576H26.7815H30.6082H34.4349V7.87109H30.6082Z" />
                  <path
                ...
                <svg class="fill-neutral-sgray stroke-cta-dark stroke-0 hamburger" width="35" height="20"
                  viewBox="0 0 35 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M11.4749 3.93832H15.3016H19.1283H22.9551H26.779H30.6057V0H26.779H22.9551H19.1283H15.3016H11.4749H7.65095H3.82422V3.93832H7.65095H11.4749Z" />
                  <path
                    d="M30.6082 7.87109H26.7815H22.9576H19.1308H15.3041H11.4774H7.65347H3.82673H0V11.8094H3.82673H7.65347H11.4774H15.3041H19.1308H22.9576H26.7815H30.6082H34.4349V7.87109H30.6082Z" />
      ...
      <?php
        $fields = get_fields($menu_item); 
      ?>
      <section class="fixed w-full bg-white shadow-md pb-s8 pt-s6 mm" style="display: none;"
        data-identifier="<?php echo $fields["identifier"]; ?>">
        <div class="container mx-auto px-s2">
          <ul class="dropdown-menu grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 items-center justify-start mx-auto">
            ...
            <li>
              <a class="grid grid-cols-[auto_auto] gap-s2 max-w-[300px] p-s2 border-2 border-transparent hover:border-neutral-200 rounded-xl"
                href="<?php echo $menu_subitem["link"]; ?>">
                <div class="p-s1 w-4 h-4 box-content rounded-md bg-secondary-glaciar col-start-1 col-end-2">
                  <img class="h-s2 w-s2 aspect-square <?php echo $menu_subitem["menu_class"]; ?>"
                    src="<?php echo $menu_subitem['icon'] ?? (get_template_directory_uri() . '/images/icons/platform.svg') ?>"
                    alt="platform icon" class="w-32 h-auto">
                </div>
    ...
    <section id="mobile-menu" style="display: none;"
      class="section fixed bg-white lg:!hidden top-0 left-0 w-screen h-screen z-[999] pb-s4">
      <div class="container mx-auto w-full flex-col items-center justify-between h-full flex pt-s6">
        <ul class="w-full flex flex-col items-start gap-s5 md:gap-s2 body-1 px-s2">
          ...
          <?php
            $fields = get_fields($menu_item); 
          ?>
          <li class="menu-item-mobile menu-item-dropdown-mobile flex flex-col items-start gap-s1 w-full group"
            data-identifier="<?php echo $fields["identifier"]; ?>">
            <div class="flex flex-row items-center justify-between w-full group">
              ...
              <?php if ($fields["menu_items"]) : ?>
              <svg class="dropdown-arrow stroke-neutral-sgray" width="13" height="7" viewBox="0 0 13 7" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M1.4502 0.825684L6.76582 6.14131L12.0814 0.825684" stroke-width="1.18" stroke-linecap="round"
                ...
                <ul class="dropdown-menu grid grid-cols-1 lg:grid-cols-3 gap-s1 items-center justify-start mx-auto">
                  ...
                  <li>
                    <a class="grid grid-cols-[2rem_auto] gap-s2" href="<?php echo $menu_subitem["link"]; ?>">
                      <div class="p-s1 w-4 h-4 box-content rounded-md bg-secondary-glaciar col-start-1 col-end-2">
                        <img class="h-s2 w-s2 aspect-square bg-secondary-glaciar"
                          src="<?php echo get_template_directory_uri(); ?>/images/icons/platform.svg"
                          alt="platform icon" class="w-32 h-auto">
                      </div>
                      <div class="flex flex-col gap-s1">
                        <span
                          class="heading-3 !font-medium text-neutral-dgray"><?php echo $menu_subitem["title"]; ?></span>
          ...
          <li class="menu-item-mobile menu-item-dropdown-mobile flex flex-col items-start gap-s1 w-full group"
            data-identifier="<?php echo $fields["identifier"]; ?>">
            <div class="flex flex-row items-center justify-between w-full group">
              <a class="md:py-s2 heading-5 text-neutral-sgray" href="<?php echo $menu_item->url; ?>"
                target="<?php echo $menu_item->title == "LinkedIn" ? "_blank" : ""; ?>"><?php echo $menu_item->title; ?></a>
            </div>
          </li>
          <?php endforeach; ?>
    ...
    closeFlag.forEach(function(item) {
      item.addEventListener('click', function() {
        ...
        document.querySelector("main#primary > *").style.paddingTop = document.querySelector(
            'header#navigation')
          .offsetHeight + 'px';
      })
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.querySelector("main#primary > *").style.paddingTop = document.querySelector('header#navigation')
        .offsetHeight + 'px';
      document.querySelector('#mobile-menu').style.paddingTop = document.querySelector('header').offsetHeight +
        'px';
    });
    ...
    function modifyNavigationColor() {
      ...
      const displayMode = window.scrollY > 0 && lastScrollPosition < window.scrollY && !mobileOpened ? 'hidden' :
        'shown';
