...
<section
  class="translucent-navigation relative section w-full pb-s12 md:pb-s7 lg:pb-s12 text-neutral-dgray bg-neutral-mgray">
    ...
    <div class="general-slide">
      ...
      <div class="general-slide__item">
        <div class="grid grid-cols-6 md:grid-cols-12 gap-s8 md:gap-x-s2 md:gap-y-s10">
          ...
          <div
            class="col-span-6 md:col-span-7 lg:col-span-5 md:col-start-6 lg:col-start-6 flex items-start justify-between gap-s2">
  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-12 gap-s2">
      ...
      <div
        ...
        <a href="javascript:void(0)" data-id="0" data-name="All"
          class="col-span-6 w-auto flex items-center justify-center h-[38px] px-s3 heading-4 text-center rounded-button uppercase bg-neutral-dgray active-filter">All</a>
        <a href="javascript:void(0)" data-id="1"
          class="col-span-6 w-auto flex items-center justify-center h-[38px] px-s2 lg:px-s3 heading-4 text-center rounded-button uppercase btn-text-link text-neutral-sgray">Past
          meetings</a>
        <a href="javascript:void(0)" data-id="2"
          class="col-span-6 w-auto flex items-center justify-center h-[38px] px-s2 lg:px-s3 heading-4 text-center rounded-button uppercase btn-text-link text-neutral-sgray">Upcoming
          meetings</a>
...
<section id="join-the-forum" class="relative section w-full pt-s12 md:pt-s10 pb-s10 md:pb-s12 bg-neutral-nwhite">
  <div class="container mx-auto px-s2 md:px-0">
