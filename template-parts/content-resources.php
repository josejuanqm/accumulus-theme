  ...
  <div class="container mx-auto lg:pt-s9">
    ...
    <div class="grid grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end pt-0">
      ...
      <div class="relative col-span-12 lg:col-span-7 flex flex-col gap-s3 lg:pr-9">
        ...
        <div
          class="relative h-full w-full max-lg:h-[416px] flex items-center justify-center bg-resources-general bg-cover bg-no-repeat bg-center">
...
<section
  class="relative section w-full pt-s8 md:pt-s10 lg:pt-s8 pb-s8 md:pb-s2 lg:pb-s4 bg-primary-violet text-neutral-nwhite bg-purple-section-mobile md:bg-purple-section-tablet lg:bg-purple-section-desktop bg-no-repeat bg-cover bg-left-top isolate">
  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-6 md:grid-cols-12 gap-4 gap-y-0">
      ...
      <div
        class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-4 gap-y-s1 pt-s6 pb-s8 md:pt-s3 md:pb-s10 lg:pt-s6 lg:pb-s6">
        <h2 class="col-span-12 md:col-span-12 lg:col-span-12 grid grid-cols-12 heading-2 capitalize gap-s2 lg:pt-s6">
          ...
          <span
            class="col-span-12 md:col-span-12 lg:col-span-12"><?php echo $purpleSection['first_line_title']; ?></span>
          <?php endif; ?>
          <?php if($purpleSection['second_line_title']): ?>
          <span
            class="col-span-12 md:col-span-12 lg:col-span-12"><?php echo $purpleSection['second_line_title']; ?></span>
          <?php endif; ?>
        </h2>
      </div>

      <p
        class="col-span-3 md:col-span-6 lg:col-span-3 lg:col-start-5 pt-s10 md:pt-s8 lg:pt-0 body-3 text-neutral-nwhite">
        <?php echo $purpleSection['first_paragraph']; ?></p>
      <p
        class="col-span-3 col-start-4 md:col-span-6 lg:col-span-3 md:col-start-7 lg:col-start-8 pt-s10 md:pt-s8 lg:pt-0 body-3 text-neutral-nwhite">
        <?php echo $purpleSection['second_paragraph']; ?></p>

      <div class="col-span-6 md:col-span-12 lg:col-span-2 lg:col-start-5 pt-s5 md:pt-s6 md:pb-s10 lg:pb-s8">
        <a href="<?php echo $purpleSection['url_cta']['url']; ?>" class="btn-tertiary-white"
          target="<?php echo $purpleSection['url_cta']['target'] ? $purpleSection['url_cta']['target'] : '_self' ?>"><?php echo $purpleSection['url_cta']['title']; ?></a>
      </div>
...
<section class="section w-full pt-s8 pb-s8 md:pb-s10 md:pt-s10 lg:pt-s8 lg:pb-s8 bg-white">
  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-12 gap-s2">
      ...
      <div
        class="filters col-span-12 pt-0 pb-s8 md:pt-s2 md:pb-s10 lg:pt-s4 lg:pb-s8 flex justify-center w-full flex-wrap gap-s2 md:gap-s4 text-neutral-sgray">

        <input type="hidden" id="category" value="0" data-catName="Last Articles">

        <a href="javascript:void(0)" data-id="0" data-name="Latest Resources"
          class="col-span-6 w-auto flex items-center justify-center h-[38px] px-s2 lg:px-s3 heading-4 text-center rounded-button uppercase btn-text-link  bg-neutral-dgray  active-filter">All</a>

        <?php foreach($categories as $category): ?>
        <a href="javascript:void(0)" data-id="<?php echo $category->term_id; ?>"
          data-name="Latest <?php echo $category->name; ?>"
          class="col-span-6 w-auto flex items-center justify-center h-[38px] px-s2 lg:px-s3 heading-4 text-center rounded-button uppercase btn-text-link text-neutral-sgray"><?= $category->name ?></a>
        <?php endforeach; ?>
...
<section class="section w-full lg:pt-s8 pb-s8 md:pb-s10 lg:pb-s4 bg-secondary-carbon text-white relative">
  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-6 md:grid-cols-12 gap-x-4 lg:gap-y-0 pt-[320px] lg:pt-0">
      ...
      <img class="absolute top-0 left-0 w-full h-[320px] lg:max-w-[500px] lg:h-full"
        src="<?php echo $eventSection['image']; ?>" alt="Events" />

      <h4
        class="col-span-4 col-start-1 md:col-span-12 md:col-start-1 lg:col-span-3 lg:col-start-6 pt-s4 md:pt-s8 lg:pt-s4 heading-4 uppercase">
        EVENTS</h4>

      <div
        class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-4 gap-y-s1 pt-s6 pb-s6 md:pt-s5 md:pb-s5">

        <h2 class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12">

          <?php if ($eventSection['first_line_title'] !== ''): ?>
          <span
            class="col-span-6 md:col-span-12 lg:col-span-7 lg:col-start-6 text-h2Mobile md:text-h2Tablet lg:text-h2 capitalize"><?php echo $eventSection['first_line_title']; ?></span>
          <?php endif; ?>
          <?php if ($eventSection['second_line_title'] !== ''): ?>
          <span
            class="col-span-3 md:col-span-6 lg:col-span-6 col-start-4 md:col-start-6 lg:col-start-6 text-h2Mobile md:text-h2Tablet lg:text-h2 capitalize"><?php echo $eventSection['second_line_title']; ?></span>
          <?php endif; ?>
      ...
      <p class="col-span-3 md:col-span-6 lg:col-span-3 lg:col-start-6 body-3">
        <?php echo $eventSection['first_paragraph']; ?></p>
      <p class="col-span-3 col-start-4 md:col-span-6 lg:col-span-3 md:col-start-7 lg:col-start-9 body-3">
        <?php echo $eventSection['second_paragraph']; ?></p>

      <div class="col-span-6 md:col-span-12 lg:col-span-2 lg:col-start-6 pt-s5 lg:pb-s8 md:pt-s5">
        <a href="<?php echo $eventSection['link_cta']['url']; ?>" class="btn-tertiary-white"
          target="<?php echo $eventSection['link_cta']['target'] ? $eventSection['link_cta']['target'] : '_self' ?>"><?php echo $eventSection['link_cta']['title']; ?></a>
      </div>
        ...
        <div class="related">
          ...
          <div class="card relative w-full max-w-[370px] rounded-card overflow-hidden mx-2">
            ...
            <div
              ...
              style="background-image: url(<?php bloginfo('template_url'); ?>/images/home/thumb-slider.png)">
              ...
              <img class="block" src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>" />
              <?php else: ?>
              <img class="block" src="<?php bloginfo('template_url'); ?>/images/events/icon-calendar.png"
                alt="<?php the_title(); ?>" />
              <?php endif; ?>
            ...
            <div class="flex flex-col p-7 gap-2 bg-neutral-nwhite">
              <div class="flex items-center gap-3 text-primary-violet uppercase">
                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    d="M13.3425 1.71011H11.7174V0.0849609H10.0923V1.71011H5.218V0.0849609H3.59285V1.71011H1.9677C1.07177 1.71011 0.34375 2.43693 0.34375 3.33406V11.4586H1.9689V3.33526H13.3425V11.4598H3.59285V13.085H13.3425C14.2397 13.085 14.9677 12.3569 14.9677 11.4598V3.33526C14.9677 2.43813 14.2397 1.71011 13.3425 1.71011Z"
                    fill="#411693" />
                </svg>
                <span>Events</span>
              </div>
              <h3 class="text-h3Mobile md:text-h6Tablet lg:text-h3 color-neutral-dgray">
                <?php truncate(get_the_title(), 140); ?></h3>
            </div>
