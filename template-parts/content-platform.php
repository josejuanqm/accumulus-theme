      ...
      <h2 class="heading-1 font-normal col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-s2 lg:pb-s1">
        ...
        <span class="col-span-6 md:col-span-10 lg:col-span-10 col-start-2 md:col-start-2 lg:col-start-2">
          <?php //echo $join_the_forum['second_line_title']; ?>
			...
			<p class="col-span-6 md:col-span-7 md:col-start-5 lg:col-span-6 lg:col-start-6 pb-s2 lg:pb-s6">Are your traditional ways of working resulting in:</p>
			...
			<div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-y-s6 md:gap-y-s8 lg:pb-s6">
				...
				<div class="col-span-6 md:col-span-7 lg:col-span-5 col-start-1 md:col-start-5 lg:col-start-6 flex items-start gap-s3">
					<img class="w-[55px] md:w-[64px] aspect-square" src="<?php bloginfo('template_url'); //echo $item['icon']; ?>/images/home/13-Years.png" alt="<?php //echo $item['title']; ?>" />
					<div class="description-wysiwyg  w-auto">
						<h3 class="heading-3"><?php //echo $item['title']; ?>Delayed global availability of therapies?</h3>
        ...
        <span class="col-span-6 md:col-span-10 lg:col-span-10 col-start-2 md:col-start-2 lg:col-start-2">
          <?php //echo $join_the_forum['second_line_title']; ?>
			...
			<p class="col-span-6 md:col-span-7 md:col-start-5 lg:col-span-6 lg:col-start-6 pb-s2 md:pb-s2 lg:pb-s6">
				Transform how information flows with the Accumulus platform. Instead of static documents, think instant communication, real-time information exchange, and dynamic insights to overcome these challenges and advance your mission.
				<br /><br />
			...
			<div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-y-s6 md:gap-y-s8 lg:pb-s6">
				...
				<div class="col-span-6 md:col-span-4 lg:col-span-4 flex items-start gap-s2">
					<img class="w-[39px] md:w-[64px] aspect-square" src="<?php bloginfo('template_url'); //echo $item['icon']; ?>/images/home/13-Years.png" alt="<?php //echo $item['title']; ?>" />
					<div class="description-wysiwyg w-auto">
						<h3 class="heading-7"><?php //echo $item['title']; ?>We believe that challenges are catalysts for innovation and progress</h3>
					</div>
				</div>
				<div class="col-span-6 md:col-span-4 lg:col-span-4 flex items-start gap-s2">
					<img class="w-[39px] md:w-[64px] aspect-square" src="<?php bloginfo('template_url'); //echo $item['icon']; ?>/images/home/13-Years.png" alt="<?php //echo $item['title']; ?>" />
...
<section class="relative section py-s8 md:py-s12 lg:py-s10 bg-primary-violet ">
	<div class="container mx-auto">
		<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s5 md:gap-y-s6 lg:gap-y-s13 text-neutral-nwhite">
			<h2 class="col-span-6 md:col-span-12 heading-2"><?php echo $key_features['title']; ?></h2>
			...
			<div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-s4">
				...
				<div class="col-span-6 md:col-span-12 lg:col-span-11 lg:col-start-2 grid grid-cols-12 gap-x-s2 lg:gap-x-s10 gap-y-s7">
					...
					<?php 
						foreach($key_features['key_features_list'] as $value): 
					?>
					<div class="col-span-12 md:col-span-6">
				...
				<div class="col-span-6 md:col-span-12 lg:col-span-11 lg:col-start-2 pt-s5 md:pt-s8 lg:pt-s3 flex flex-col lg:flex-row items-center justify-center gap-s3 md:gap-s4 lg:gap-s2">
					<a href="<?php echo $key_features['link_cta_request_a_demo']; ?>" class="btn-secondary-inverted"><?php echo $key_features['text_cta_request_a_demo']; ?></a>
					<a href="<?php echo $key_features['link_cta_learn_more']; ?>" class="btn-tertiary-white"><?php echo $key_features['text_cta_learn_more']; ?></a>
				</div>
