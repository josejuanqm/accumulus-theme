...
<section class="translucent-navigation section w-full pb-s12 md:pb-s7 lg:pb-s12 bg-cover bg-no-repeat bg-center bg-neutral-offwhite" style="background-image: url(<?php echo $row['main_banner_with_marquee_group']['bg_image_main']; ?>)">

	<div class="container mx-auto pt-s5 md:pt-s10 lg:pt-s9">

		<div class="grid grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">

			<h4 class="col-span-12 text-h4Mobile md:text-h4Tablet lg:text-h4 uppercase pt-s1"><?php echo $row['main_banner_with_marquee_group']['title_tag']; ?></h4>
			<h1 class="col-span-12 text-h1Mobile md:text-h1Tablet lg:text-h1"><?php echo $row['main_banner_with_marquee_group']['main_title']; ?></h1>

			<div class="col-span-12 md:col-span-6 md:col-start-6 flex flex-col md:items-end lg:items-start gap-s8 lg:gap-s4">
				<p class="body-2 md:max-w-550 lg:max-w-full"><?php echo $row['main_banner_with_marquee_group']['resume_text']; ?></p>
			</div>
			<div class="col-span-12 lg:col-span-6 lg:col-start-6 flex flex-col lg:flex-row gap-s2 lg:gap-s4">
				...
				<a 
					target="<?php echo $row['main_banner_with_marquee_group']['link_demo']['target'] ? $row['main_banner_with_marquee_group']['link_demo']['target'] : '_self'; ?>" 
					href="<?php echo  $row['main_banner_with_marquee_group']['link_demo']['url']; ?>" 
					class="btn-secondary">
				...
				<a 
					target="<?php echo $row['main_banner_with_marquee_group']['link_learn_more']['target'] ? $row['main_banner_with_marquee_group']['link_learn_more']['target'] : '_self'; ?>" 
					href="<?php echo  $row['main_banner_with_marquee_group']['link_learn_more']['url']; ?>" 
					class="btn-tertiary">
...
<section class="translucent-navigation section w-full pb-s12 md:pb-s7 lg:pb-s12 bg-cover bg-no-repeat bg-center bg-neutral-offwhite" style="background-image: url(<?php echo $row['main_banner_group']['bg_image_main']; ?>)">

	<div class="container mx-auto pt-s5 md:pt-s10 lg:pt-s9">

		<div class="grid grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">

			<h4 class="col-span-12 text-h4Mobile md:text-h4Tablet lg:text-h4 uppercase pt-s1"><?php echo $row['main_banner_group']['title_tag']; ?></h4>
			<h1 class="col-span-12 text-h1Mobile md:text-h1Tablet lg:text-h1"><?php echo $row['main_banner_group']['main_title']; ?></h1>
			...
			<div class="col-span-12 lg:col-span-6 lg:col-start-6 flex flex-col lg:flex-row gap-s2 lg:gap-s4">
				...
				<a 
					target="<?php echo $row['main_banner_group']['link_demo']['target'] ? $row['main_banner_group']['link_demo']['target'] : '_self'; ?>" 
					href="<?php echo  $row['main_banner_group']['link_demo']['url']; ?>" 
					class="btn-secondary">
				...
				<a 
					target="<?php echo $row['main_banner_group']['link_learn_more']['target'] ? $row['main_banner_group']['link_learn_more']['target'] : '_self'; ?>" 
					href="<?php echo  $row['main_banner_group']['link_learn_more']['url']; ?>" 
					class="btn-tertiary">
...
<section class="translucent-navigation relative section w-full pb-s10 md:pb-s12 lg:pb-s12 text-neutral-dgray bg-neutral-white md:overflow-hidden">
	...
	<picture class="absolute top-0 left-0 w-full h-full -z-[1]">
		...
		<img src="<?php echo  $row['main_banner_group']['bg_image_mobile']; ?>" alt="<?php echo  $row['main_banner_group']['title']; ?>" class="w-full h-full">
	</picture>
	...
	<div class="container mx-auto z-10 pt-s5 md:pt-s10 lg:pt-s9">
		...
		<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">
			...
			<h4 class="col-span-6 md:col-span-12 lg:row-start-1 heading-4 uppercase"><?php echo  $row['main_banner_group']['flag_title']; ?></h4>

			<h1 class="col-span-5 md:col-span-12 lg:col-span-8 lg:row-start-2 heading-1"><?php echo  $row['main_banner_group']['title']; ?></h1>
			...
			<div class="col-span-6 md:col-span-12 lg:absolute lg:-right-[80px] xl:right-0 flex justify-end">
				<picture class="relative max-lg:max-w-[75%] max-md:max-w-full">
					...
					<img src="<?php echo  $row['main_banner_group']['image_mobile']; ?>" alt="<?php echo  $row['main_banner_group']['title']; ?>" class="w-full h-full">
				</picture>
			</div>
			...
			<div class="col-span-6 md:col-span-12 lg:row-start-4 flex flex-col lg:flex-row gap-s2 lg:gap-s4">
				...
				<a href="<?php echo  $row['main_banner_group']['link_first_cta']; ?>" class="btn-secondary"><?php echo  $row['main_banner_group']['text_first_cta']; ?></a>
				<?php endif; ?>

				<?php if($row['main_banner_group']['text_second_cta'] !== ''): ?>
				<a href="<?php echo  $row['main_banner_group']['link_second_cta']; ?>" class="btn-tertiary"><?php echo  $row['main_banner_group']['text_second_cta']; ?></a>
				<?php endif; ?>
...
<section class="translucent-navigation light section w-full relative pb-s12 md:pb-s7 lg:pb-s12 text-neutral-nwhite bg-secondary-green">
	...
	<picture class="absolute top-0 left-0 w-full h-full">
		...
		<img src="<?php echo $row['main_banner_group']['bg_image_for_mobile']; ?>" alt="<?php echo $row['main_banner_group']['title']; ?>" class="w-full h-full">
	</picture>
	...
	<div class="relative container mx-auto pt-s5 md:pt-s10 lg:pt-s9">
		...
		<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">
			...
			<h1 class="col-span-5 md:col-span-6 lg:col-span-7 lg:row-start-2 heading-1"><?php echo $row['main_banner_group']['title']; ?></h1>

			<div class="col-span-6 md:col-span-6 lg:col-span-5 lg:row-start-2 text-end">
				<img class="relative inline-block" src="<?php echo $row['main_banner_group']['image']; ?>" alt="<?php echo $row['main_banner_group']['title']; ?>" />
			</div>
...
<section class="translucent-navigation light relative section w-full pb-s12 md:pb-s7 lg:pb-s12 text-neutral-fnude bg-secondary-carbon">
	...
	<picture class="absolute top-0 left-0 w-full h-full">
		<source media="(min-width:1024px)" srcset="<?php echo $row['main_banner_inner_pages_group']['bg_image_for_desktop']; ?>">
		<source media="(min-width:768px)" srcset="<?php echo $row['main_banner_inner_pages_group']['bg_image_for_tablet']; ?>">
		<img src="<?php echo $row['main_banner_inner_pages_group']['bg_image_for_mobile']; ?>" alt="Flowers" class="w-full h-full">
	</picture>
	...
	<div class="relative container mx-auto pt-s5 md:pt-s10 lg:pt-s9">
		...
		<div class="grid grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">
			...
			<h4 class="col-span-12 heading-4 uppercase pt-s1 text-neutral-nude"><?php echo $row['main_banner_inner_pages_group']['title_tag']; ?></h4>
			<h1 class="col-span-12 heading-1 text-neutral-nude"><?php echo $row['main_banner_inner_pages_group']['main_title']; ?></h1>

			<div class="col-span-12 md:col-span-6 md:col-start-6 flex flex-col md:items-end lg:items-start gap-s8 lg:gap-s4">
				<p class="body-2 md:max-w-550 lg:max-w-full text-neutral-nwhite"><?php echo $row['main_banner_inner_pages_group']['resume_text']; ?></p>
			</div>
			<div class="col-span-12 lg:col-span-6 lg:col-start-6 flex flex-col lg:flex-row gap-s2 lg:gap-s4">

				<?php if($row['main_banner_inner_pages_group']['link_demo']): ?>
				<a 
					target="<?php echo $row['main_banner_inner_pages_group']['link_demo']['target'] ? $row['main_banner_inner_pages_group']['link_demo']['target'] : '_self'; ?>" 
				...
				<a 
					target="<?php echo $row['main_banner_inner_pages_group']['link_learn_more']['target'] ? $row['main_banner_inner_pages_group']['link_learn_more']['target'] : '_self'; ?>" 
...
<section class="relative section w-full pt-s7 md:pt-s8 lg:pt-0 pb-s10 md:pb-s10 lg:pb-s12 bg-neutral-nude">
	<div class="container mx-auto">
		<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s5 md:gap-y-s4 lg:gap-y-s6">
			<p class="col-span-6 md:col-span-8 lg:col-span-8 col-start-2 md:col-start-3 lg:col-start-4 md:pt-s4 lg:pt-0 md:pb-s4 lg:pb-0 body-2"><?php echo $row['statistics_group']['resume_testimonial']; ?></p>
			<div class="col-span-6 md:col-span-7 lg:col-span-4 md:col-start-6 lg:col-start-6 flex items-center justify-start pt-s3 md:pt-0">
				<img class="max-w-[145px] md:max-w-full" src="<?php echo $row['statistics_group']['photo_testimonial']; ?>" alt="<?php echo $row['statistics_group']['name_testimonial']; ?>" />
				<div class="flex flex-col pl-s2 md:pl-s6 lg:pl-s2 md:pr-s3 lg:pr-0 gap-s2">
					<h4 class="heading-3 text-neutral-dgray w-full md:max-w-[195px]"><?php echo $row['statistics_group']['name_testimonial']; ?></h4>
	...
	<div class="container mx-auto">
		<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s5 md:gap-y-s6 lg:gap-y-s13 text-neutral-nwhite">
			...
			<div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-s4">
				...
				<p class="body-2 col-span-6 md:col-span-12 lg:col-span-11 lg:col-start-2"><?php echo $row['how_it_works_group']['resume']; ?></p>
				...
				<div class="col-span-6 md:col-span-12 lg:col-span-11 lg:col-start-2 pt-s5 md:pt-s8 lg:pt-s3 flex flex-col lg:flex-row items-center justify-center gap-s3 md:gap-s4 lg:gap-s2">
					...
					<a 
						target="<?php echo $row['how_it_works_group']['link_request_a_demo']['target'] ? $row['how_it_works_group']['link_request_a_demo']['target'] : '_self'; ?>" 
					...
					<a 
						target="<?php echo $row['how_it_works_group']['link_learn_more']['target'] ? $row['how_it_works_group']['link_learn_more']['target'] : '_self'; ?>" 
						href="<?php echo  $row['how_it_works_group']['link_learn_more']['url']; ?>" 
  ...
  <div class="container mx-auto">
    <div class="grid grid-cols-6 md:grid-cols-12 gap-s8 md:gap-x-s2 md:gap-y-s10">
      ...
      <div class="col-span-6 md:col-span-7 lg:col-span-5 md:col-start-6 lg:col-start-6 lg:pl-s6 flex items-center justify-start">
        <img class="max-w-[145px] md:max-w-full" src="<?php echo $row['testimonial_group']['image']; ?>" alt="<?php echo $row['testimonial_group']['name']; ?>" />
        <div class="flex flex-col pl-s2 gap-s2">
          <?php if($row['testimonial_group']['name'] !== ''): ?>
          <h4 class="text-h3Mobile md:text-h3Tablet lg:text-h3 text-neutral-dgray w-full md:max-w-[195px]"><?php echo $row['testimonial_group']['name']; ?></h4>
          <?php endif; ?>
...
<section class="what-we-do-home relative z-10 section w-full pt-s10 md:pt-s16 lg:pt-s20 pb-s14 lg:pb-s12 -mt-s10 lg:-mt-s12 bg-cover bg-no-repeat bg-center bg-what-we-do-mobile md:bg-what-we-do-tablet lg:bg-what-we-do-desktop bg-transparent">
	...
	<div class="container mx-auto md:pt-s14 lg:pt-s14 lg:pb-s14">
		...
		<div class="grid grid-cols-12 gap-x-s2 gap-y-s6">
			...
			<h4 class="col-span-12 md:col-span-12 col-start-1 text-h4Mobile md:text-h4Tablet lg:text-h4 text-neutral-nwhite uppercase"><?php echo $row['what_we_do_group']['title_tag']; ?></h4>
			<h2 class="col-span-12 md:col-span-11 lg:col-span-11 col-start-1 text-h2Mobile md:text-h2Tablet lg:text-h2 text-neutral-nwhite"><?php echo $row['what_we_do_group']['main_title']; ?></h2>
			<p class="col-span-12 md:col-span-6 lg:col-span-4 lg:col-start-4 text-neutral-nwhite body-2"><?php echo $row['what_we_do_group']['first_description']; ?></p>
			<p class="col-span-12 md:col-span-6 lg:col-span-4 md:col-start-7 lg:col-start-8 text-neutral-nwhite body-2"><?php echo $row['what_we_do_group']['second_description']; ?></p>
			<div class="col-span-12 lg:col-span-3 lg:col-start-4 flex flex-col lg:flex-row gap-s2 lg:gap-s4">
				...
				<?php if($row['what_we_do_group']['link_request_a_demo']): ?>
					<a 
						target="<?php echo $row['what_we_do_group']['link_request_a_demo']['target'] ? $row['what_we_do_group']['link_request_a_demo']['target'] : '_self'; ?>" 
						href="<?php echo  $row['what_we_do_group']['link_request_a_demo']['url']; ?>" 
						class="btn-secondary-inverted">
				...
				<?php if($row['what_we_do_group']['link_learn_more']): ?>
					<a 
						target="<?php echo $row['what_we_do_group']['link_learn_more']['target'] ? $row['what_we_do_group']['link_learn_more']['target'] : '_self'; ?>" 
						href="<?php echo  $row['what_we_do_group']['link_learn_more']['url']; ?>" 
						class="btn-tertiary-white">
	...
	<div class="container mx-auto">
		...
		<?php if($row['acf_fc_layout'] == 'mission_challenges_layout') : ?>
			<div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2 gap-y-s4 md:gap-y-s6">
				...
				<p class="body-2 col-span-6 md:col-span-7 md:col-start-5 lg:col-span-6 lg:col-start-6 pb-s2 lg:pb-s6"><?php echo $row['mission_challenges_group']['resume']; ?></p>
...
<section class="section relative w-full py-s10 bg-secondary-aqua flex flex-col gap-s9">
	...
	<div class="flex flex-col items-center text-center justify-stretch md:justify-normal gap-s4">
		...
		<?php if($row['case_study_group']['cta_text']): ?>
			<a 
				target="<?php echo $row['case_study_group']['cta_text']['target'] ? $row['case_study_group']['cta_text']['target'] : '_self'; ?>" 
				href="<?php echo  $row['case_study_group']['cta_text']['url']; ?>" 
...
<section class="relative section w-full pt-s8 md:pt-s12 pb-s8 md:pb-s12 bg-primary-glaciar bg-benefits-mobile md:bg-benefits-tablet lg:bg-benefits-desktop bg-cover bg-no-repeat bg-left-bottom">
  <div class="container mx-auto flex flex-col gap-s8 md:gap-s10 lg:gap-s8">
    <div class="grid grid-cols-6 md:grid-cols-12 gap-s4">
      ...
      <h2 class="col-span-6 md:col-span-4 lg:col-span-4 heading-2 pt-s2 lg:pt-0"><?php echo $row['benefits_group']['title']; ?></h2>
			...
			<div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 gap-s4">
				...
				<div class="col-span-6 md:col-span-12 lg:col-span-11 lg:col-start-2 pt-s5 md:pt-s8 lg:pt-s3 flex flex-col lg:flex-row items-center justify-center gap-s3 md:gap-s4 lg:gap-s2">
					...
					<?php if($row['key_features_group']['link_request_a_demo']): ?>
						<a 
							target="<?php echo $row['key_features_group']['link_request_a_demo']['target'] ? $row['key_features_group']['link_request_a_demo']['target'] : '_self'; ?>" 
					...
					<?php if($row['key_features_group']['link_learn_more']): ?>
						<a 
							target="<?php echo $row['key_features_group']['link_learn_more']['target'] ? $row['key_features_group']['link_learn_more']['target'] : '_self'; ?>" 
							href="<?php echo  $row['key_features_group']['link_learn_more']['url']; ?>" 
							class="btn-tertiary-white">
...
<section class="relative section w-full pt-s13 md:pt-s12 lg:pt-s8 pb-s4 md:pb-s6 lg:pb-s12">
    ...
    <div class="grid grid-cols-12 gap-x-s2 gap-y-0">
			<h4 class="col-span-12 md:col-span-12 col-start-1 pb-s6 heading-4 uppercase"><?php echo $row['value_propositions_group']['flag_title']; ?></h4>
        ...
        <span class="col-span-10 lg:col-span-9 md:col-start-2 lg:col-start-3"><?php echo $row['value_propositions_group']['title_third_line']; ?></span>
				<?php endif; ?>
      </h2>
		</div>
    <?php endif; ?>
...
<section class="relative section w-full pt-s5 md:pt-s10 pb-s8 md:pb-s12 -mt-[2.3rem] md:-mt-s10 lg:-mt-s10  bg-primary-glaciar bg-about-envision-mobile md:bg-about-envision-tablet lg:bg-about-envision-desktop bg-cover bg-no-repeat bg-left-bottom">
  <div class="container mx-auto flex flex-col gap-s8 md:gap-s10 lg:gap-s8">
    <div class="grid grid-cols-6 md:grid-cols-12 gap-s6">
      ...
      <h2 class="col-span-6 md:col-span-12 lg:col-span-12 heading-2 pt-s8 md:pt-s12 lg:pt-s10"><?php echo $row['envision_section_group']['title']; ?></h2>
  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-6 md:grid-cols-12 gap-x-s2">
      ...
      <div class="col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12">
        <h2 class="col-span-6 md:col-span-8 lg:col-span-8 heading-2 pb-s3 md:pb-s6"><?php echo $row['case_study_group']['title']; ?></h2>
      </div>
      <div class="col-span-6 md:col-span-12 lg:col-span-4 pb-s5 lg:pb-0">
        <picture class="w-full">
          ...
          <img src="<?php echo $row['case_study_group']['image_mobile']; ?>" alt="<?php echo $row['case_study_group']['title']; ?>" class="h-full w-full">
        </picture>
      </div>
      ...
      <div class="col-span-6 md:col-span-12 lg:col-span-4 lg:col-start-6 pt-s5 md:pt-s8 lg:pt-s10">
				...
				<?php if($row['case_study_group']['cta_link']): ?>
					<a 
						target="<?php echo $row['case_study_group']['cta_link']['target'] ? $row['case_study_group']['cta_link']['target'] : '_self'; ?>" 
						href="<?php echo  $row['case_study_group']['cta_link']['url']; ?>" 
						class="btn-secondary">
...
<section class="what-we-do-home relative z-10 section w-full pt-s10 md:pt-s20 lg:pt-s20 pb-s14 md:pb-s20 lg:pb-s12 -mt-s10 lg:-mt-s12 bg-cover bg-no-repeat bg-center bg-what-we-do-mobile md:bg-what-we-do-about-tablet lg:bg-what-we-do-desktop bg-transparent">
	...
	<div class="container mx-auto md:pt-s1 lg:pt-s18 pb-s1 lg:pb-s18">
		...
		<div class="grid grid-cols-12 gap-x-s2 gap-y-s6">
			...
			<h4 class="col-span-12 md:col-span-12 col-start-1 text-h4Mobile md:text-h4Tablet lg:text-h4 text-neutral-nwhite uppercase"><?php echo $row['what_we_do_group']['what_title_tag']; ?></h4>
			<h2 class="col-span-12 md:col-span-11 lg:col-span-11 col-start-1 text-h2Mobile md:text-h2Tablet lg:text-h2 text-neutral-nwhite"><?php echo $row['what_we_do_group']['what_main_title']; ?></h2>
			<p class="col-span-12 md:col-span-6 lg:col-span-4 lg:col-start-4 text-neutral-nwhite body-2"><?php echo $row['what_we_do_group']['what_first_description']; ?></p>
			<p class="col-span-12 md:col-span-6 lg:col-span-4 md:col-start-7 lg:col-start-8 text-neutral-nwhite body-2"><?php echo $row['what_we_do_group']['what_second_description']; ?></p>
  ...
  <div class="container mx-auto">
    ...
    <div class="flex items-center justify-center pt-s5 md:pt-s6 lg:pt-s10">
			...
			<?php if($row['why_accumulus_group']['cta_link']): ?>
				<a 
					target="<?php echo $row['why_accumulus_group']['cta_link']['target'] ? $row['why_accumulus_group']['cta_link']['target'] : '_self'; ?>" 
					href="<?php echo  $row['why_accumulus_group']['cta_link']['url']; ?>" 
					class="btn-tertiary">
          ...
          Contact Us
				...
				<div class="col-span-12 pt-s4 lg:pt-0 lg:col-span-3 hidden lg:flex items-end gap-4">
					<p class="body-2 leading-6">
						...
						<a href="tel:<?php echo $row['contact_group']['phone_number'] ?>"><?php echo $row['contact_group']['phone_number'] ?></a>
						<?php endif; ?>
						<br />
						<?php if($row['contact_group']['contact_email'] !== ''): ?>
						<a href="mailto: <?php echo $row['contact_group']['contact_email']; ?>"><?php echo $row['contact_group']['contact_email']; ?></a>
						<?php endif; ?>
					</p>
					<?php 
...
<section class="relative section w-full pt-s12 pb-s12 bg-neutral-nude bg-get-started-section-mobile md:bg-get-started-section-tablet lg:bg-get-started-section-desktop bg-cover bg-no-repeat bg-center">
	<div class="container mx-auto">
		...
		<div class="grid grid-cols-12 gap-x-s2 gap-y-s3 md:gap-y-s6">
			...
			<h6 class="col-span-12 text-h4Mobile md:text-h4Tablet lg:text-h4 uppercase"><?php echo $row['ready_to_join_us_group']['eyebrown']; ?></h6>
			<h2 class="col-span-12 text-h2Mobile md:text-h2Tablet lg:text-h2"><?php echo $row['ready_to_join_us_group']['title']; ?></h2>
			<p class="col-span-12 md:col-span-6 lg:col-span-4 text-b3Mobile md:text-b3Tablet lg:text-b3 py-s2 md:py-0"><?php echo $row['ready_to_join_us_group']['resume']; ?></p>
			<div class="col-span-12 flex justify-start">
				<?php if($row['ready_to_join_us_group']['cta_link']): ?>
					<a 
						target="<?php echo $row['ready_to_join_us_group']['cta_link']['target'] ? $row['ready_to_join_us_group']['cta_link']['target'] : '_self'; ?>" 
						href="<?php echo  $row['ready_to_join_us_group']['cta_link']['url']; ?>" 
						class="btn-tertiary">
      ...
      <div class="body-3 text-neutral-100 col-span-12 md:col-span-5 row-start-3">
        <?php echo $carreers_footer['resume'] ?>
			...
			<?php if($carreers_footer['cta_link']): ?>
				<a 
					target="<?php echo $carreers_footer['cta_link']['target'] ? $carreers_footer['cta_link']['target'] : '_self'; ?>" 
