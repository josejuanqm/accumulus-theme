...
<section
  class="translucent-navigation <?php echo $row['main_banner_inner_pages_group']['text_white'] ? 'light' : ''; ?> relative section w-full pb-s12 md:pb-s7 lg:pb-s12 <?php echo $row['main_banner_inner_pages_group']['text_white'] ? 'text-neutral-fnude' : ''; ?>  bg-secondary-carbon">
  ...
  <div class="relative container mx-auto pt-s5 md:pt-s10 lg:pt-s9">
    ...
    <div class="grid grid-cols-12 gap-x-s2 gap-y-s6 lg:justify-end">
      ...
      <h4
        class="col-span-12 heading-4 uppercase pt-s1 <?php echo $row['main_banner_inner_pages_group']['text_white'] ? 'text-neutral-fnude' : ''; ?>">
        <?php echo $row['main_banner_inner_pages_group']['title_tag']; ?></h4>
      <h1
        class="col-span-12 heading-1 <?php echo $row['main_banner_inner_pages_group']['text_white'] ? 'text-neutral-fnude' : ''; ?>">
        <?php echo $row['main_banner_inner_pages_group']['main_title']; ?></h1>

      <div class="col-span-12 md:col-span-6 md:col-start-6 flex flex-col md:items-end lg:items-start gap-s8 lg:gap-s4">
        <p
          class="body-2 md:max-w-550 lg:max-w-full <?php echo $row['main_banner_inner_pages_group']['text_white'] ? 'text-neutral-nwhite' : ''; ?>">
      ...
      <div
        ...
        <a target="<?php echo $row['main_banner_inner_pages_group']['link_learn_more']['target'] ? $row['main_banner_inner_pages_group']['link_learn_more']['target'] : '_self'; ?>"
          ...
          class="<?php echo $main_banner_inner ? 'btn-tertiary' : 'btn-secondary'; ?>">
