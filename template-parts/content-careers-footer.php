<section class="section bg-neutral-900 py-s7 md:py-s12 relative isolate overflow-hidden">
  ...
  <div class="container mx-auto">
    <div class="grid grid-cols-12 gap-x-s2 items-start gap-y-s6">
      ...
      <p class="body-3 text-neutral-100 col-span-12 md:col-span-5 row-start-3">
      Great achievements require great team members. 
      <br /><br />
      We’re a group of passionate individuals driven by a common purpose — to bring medicines to patients around the globe faster. We’re excited to learn how you can help us!
      </p>
