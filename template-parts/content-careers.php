...
<section class="section relative isolate overflow-hidden w-full pt-0 lg:pt-52 2xl:pt-60 pb-s12 md:pb-s7 lg:pb-s12 text-neutral-fnude bg-primary-violet bg-cover bg-no-repeat bg-center">
