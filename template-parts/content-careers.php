...
<section
  class="translucent-navigation light section relative isolate overflow-hidden w-full pb-s8 md:pb-s10 lg:pb-s12 text-neutral-fnude bg-primary-violet bg-cover bg-no-repeat bg-center">
  <picture class="absolute top-0 left-0 w-full h-full -z-10">
    ...
    <img src="<?php echo $main_banner['bg_banner_mobile']; ?>" alt="<?php echo $main_banner['title']; ?>"
      class="w-full h-full">
  </picture>
  <div class="container mx-auto pt-s5 md:pt-s8 lg:pt-s9">
    <div class="grid grid-cols-12 gap-x-s2 lg:justify-end">
      ...
      <h1 class="col-span-12 text-neutral-fnude heading-1 mt-s3 md:mt-s4 lg:mt-s6 mb-s3 md:mb-s15 lg:mb-[12rem]">
        <?php echo $main_banner['title']; ?></h1>
      <div
        class="col-span-12 md:col-span-6 md:col-start-6 flex flex-col md:items-end lg:items-start gap-s8 lg:gap-s4 mt-s10 md:mt-0 mb-s5 md:mb-s9 lg:mb-s4">
      ...
      <div class="col-span-12 lg:col-span-6 lg:col-start-6 flex flex-col lg:flex-row gap-s2 lg:gap-s4">
        ...
        <a href="<?php echo $main_banner['cta_link']; ?>"
          class="btn-secondary-inverted"><?php echo $main_banner['cta_text']; ?></a>
        <?php endif; ?>
      </div>
    </div>
  </div>
...
<section class="section relative w-full py-s8 md:py-s10 lg:py-s12 bg-neutral-offwhite">
  <div class="container mx-auto">
    ...
    <div class="flex items-center justify-center pt-s5 md:pt-s6 lg:pt-s10">
      <a href="<?php echo $why_accumulus['link_cta']; ?>"
        class="btn-tertiary"><?php echo $why_accumulus['text_cta']; ?></a>
    </div>
  </div>
</section>
  ...
  <div class="container mx-auto">
    <div class="grid grid-cols-12 gap-x-s2 items-start gap-y-s3 md:gap-y-s6">
      ...
      <h2 class="heading-2 text-neutral-offwhite col-span-12 md:col-span-10 lg:col-span-9 row-start-2 pb-s2 md:pb-0">
        Join Us</h2>
      <p class="body-3 text-neutral-offwhite col-span-12 md:col-span-6 lg:col-span-7 md:row-start-3">Join our diverse
        and ambitious team driven to pave the way for advancements in the regulatory ecosystem through creative and
        innovative solutions.<br />Whether you’re an experienced professional, or just starting your career journey, if
        you’re motivated to make a difference, we want to hear from you.*</p>
      <p
        ...
        *Please review our <a href="https://www.accumulus.org/global-applicant-privacy-notice/" target="_blank">Global
          Applicant Privacy Notice</a> for more information on how we use your job application data.</p>
      <a href="/careers"
        class="btn btn-tertiary-white col-span-12 md:col-span-12  lg:col-auto lg:row-start-4 mt-s2 md:mt-0"><?php echo $args['cta'] ?? 'Join Our Team'; ?></a>
    </div>
  </div>
</section>
