...
?>
	...
	<section class="section w-full lg:pt-72 pb-s4 md:pb-s7 lg:pb-s12 bg-primary-violet min-h-screen bg-no-repeat bg-left-top bg-cover" style="background-image: url(<?php bloginfo( 'template_url' ); ?>/images/bg-404.png);">

		<div class="container mx-auto">

			<div class="grid grid-cols-12 gap-x-4 gap-y-s6 pt-40 md:pt-52 lg:pt-0 max-lg:content-between max-lg:h-screen">
