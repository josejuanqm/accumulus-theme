...
?>
	...
	<section class="section translucent-navigation light w-full pb-s4 md:pb-s7 lg:pb-s12 bg-primary-violet min-h-screen bg-404-mobile md:bg-404-tablet lg:bg-404-desktop bg-no-repeat bg-left-top bg-contain max-lg:h-screen">
