...
/*Template name: Regulatory Insights */
...
<main id="primary" class="site-main">
  ...
  <?php
    while (have_posts()) :
        ...
        get_template_part('template-parts/content', 'regulatory-insights');
...
<?php 
    $category = get_term_by( 'slug', 'regulatory-insights', 'resources-taxonomies' );
?>
